...
public class HomePage extends Browser {
	...
	public static void clickOnSignIn() throws Exception {
		//taking screenshot and log the action in extentreport
	...
	public static void deleteingCartData() {
	    ...
	    try {  
	        if (obj.counterElement.isEmpty()) {  
	        	//if counterelement is empty then returns nothing
	            return;
	        }
	        ...
	        while (true) {
	            ...
	            //click on first item "remove element"
                ...
                //wait until the removed item no longer avaliable in DOM.
